// GENERATED AUTOMATICALLY FROM 'Assets/VictorsStuff/SharkMovement 1.inputactions'
...
public class @SharkMovement1 : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @SharkMovement1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""SharkMovement 1"",
    ""maps"": [
        {
            ""name"": ""Shark"",
    ...
    {
        private @SharkMovement1 m_Wrapper;
        public SharkActions(@SharkMovement1 wrapper) { m_Wrapper = wrapper; }
